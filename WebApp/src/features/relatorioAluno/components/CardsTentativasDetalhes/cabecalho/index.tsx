      ...
      <Conteudo>
        <ConteudoInical>
          <div className='voltar'> 
            <ChevronLeft size={30} color='#64748b' onClick={() => navigate(-1)} />
            <div>
              <Tipografias.Titulo>Histórico detalhado das Tentativas</Tipografias.Titulo>
              <Tipografias.Legenda>Detalhes das tentativas da sala {resumo?.nome_sala}</Tipografias.Legenda>
            </div>
          </div>
        </ConteudoInical>
      </Conteudo>
