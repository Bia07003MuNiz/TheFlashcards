...
import { CardGrafico, ConteinerAcerto, ConteinerAcertosErros, ConteinerData, ConteinerDireito, ConteinerErro, ConteinerPontuacao, Conteudo } from './styles';
...
const { tentativas, loadingTentativas } = useRelatorioAlunoBuscar(undefined, tentativaId);
  ...
  <Conteudo>
    ...
    <Box flex={1} minWidth={300}>
      <Tipografias.LegendaMedio>✖ Incorretas</Tipografias.LegendaMedio>
